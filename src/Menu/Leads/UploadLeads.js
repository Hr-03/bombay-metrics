...
.then((list)=>{
  ...
  useEffect(()=>{
    const leadsUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetLeadsList`;
            ...
            </Col>
            {
              ...
              xlFileName && (
                ...
                <Button className="conf-up" onClick={(e)=>{
                  e.preventDefault();
                  const excelUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/AddNewLeads`;
