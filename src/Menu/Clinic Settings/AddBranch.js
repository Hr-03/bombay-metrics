...
const locUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetLocationList/34`
    useEffect(()=>{
fetch(locUrl)
.then((res)=>res.json())
.then((location)=>{
  ...
  setLocation(location.Data);
    ...
    const respUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetUserList`;
    ...
    const handleSubmit=(e)=>{
      ...
      const addBranchUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/AddNewClinic`;
    ...
    return(
      ...
      <Main open={open}>
       ...
       <Card className="m-1 mt-3 addb-crd p-3 border-0">
            ...
            <Row>
                <Col md={3}>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control type="text" name="ClinicName" value={data.ClinicName}  placeholder="" onChange={(e) => handle(e)} />
        ...
        <Form.Control type="text" name="Address1" placeholder="" onChange={(e) => handle(e)}/>
      ...
      <option></option>
      {
        ...
        <Form.Label>Location</Form.Label>
                ...
                <Form.Select name="LocationID" value={data.LocationID} aria-label="Default select example" onChange={(e) => handle(e)}>
      <option></option>
          ...
          return(
            ...
            <Row>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control type="tel" name="MobileNo" value={data.MobileNo} placeholder="" onChange={(e) => handle(e)}/>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Select name="ResponsiblePerson" value={data.ResponsiblePerson} aria-label="Default select example" onChange={(e) => handle(e)}>
      <option></option>
          ...
          return(
            ...
            <option value={person?.UserID}>{person?.Name}</option>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control type="time" name="OpeningTime" value={data.OpeningTime} placeholder="" onChange={(e) => handle(e)}/>
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Control type="time" name="ClosingTime" value={data.ClosingTime} placeholder="" onChange={(e) => handle(e)}/>
            ...
            <Row>
              ...
              <Form.Group className="mb-3" controlId="formBasicEmail">
                            ...
                            <Form.Select name="WorkingDays" value={data.WorkingDays} aria-label="Default select example" onChange={(e) => handle(e)}>
      <option></option>
      ...
      <option value="7">7</option>
            ...
            <Row className="mt-4">
                ...
                <Col>
                <Button variant="" type="submit" className="addb-sub-btn">Submit</Button>
                </Col>
                <Col>
                <Button variant="" type="reset" className="addb-res-btn">Reset</Button>
                </Col>
            </Row>
