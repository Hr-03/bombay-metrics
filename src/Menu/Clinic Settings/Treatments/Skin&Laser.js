...
const getSlUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetSkinNHairTreatment`;
...
<Modal show={show} onHide={handleMClose} centered>
        ...
        <Modal.Footer>
          ...
          <Button variant="" onClick={()=>{
            let addslUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/AddTreatmentSkinAndLaser`;
