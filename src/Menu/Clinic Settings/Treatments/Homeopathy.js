...
const navigate=useNavigate();
    ...
    const getHpUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetHomeopathyTreatment`;
...

            {
              ...
              <Modal show={show} onHide={handleMClose} centered>
                      ...
                      <Modal.Footer>
                        ...
                        <Button variant="" 
                        onClick={()=>{
                          const htUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/AddTreatmentHomeopathy`;
