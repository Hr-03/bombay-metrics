...
const getWlUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetWeightLossTreatment`;
  useEffect(()=>{
    fetch(getWlUrl)
    .then((res)=>res.json())
    .then((wlRes)=>{
...
<Modal show={show} onHide={handleMClose} centered>
        ...
        <Modal.Footer>
          ...
          <Button variant="" onClick={()=>{
            const addwlUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/AddTreatmentWeightloss`;
