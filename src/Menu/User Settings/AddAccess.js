...
function AddAccess() {
  ...
  const rolesUrl = `https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetRoleList`;
  useEffect(() => {
    fetch(rolesUrl)
      .then((res) => res.json())
      .then((rolesRes) => {
  ...
  const handleSubmitAccess=(e)=>{
    ...
    const addAccessUrl=`https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/AddNewMenuAccess`;
  ...
  const menuAccessUrl = `https://orthosquare.infintrixindia.com/ReviveAPI/Revive.svc/GetMenuList`;
